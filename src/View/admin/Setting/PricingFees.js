                  ...
                  <div className=" text-center h-100">
                    <div className="card-body d-flex flex-column">
                      <div className="mb-4">
                        ...
                        {error && error.transactionFee && (
                          <p className="error">
                            {error ? (error.transactionFee ? error.transactionFee : '') : ''}
                          </p>
                        )}
                      </div>
                    ...
                    <div className="mt-auto">
                      {changeTransaction ? (
                        <button
                          className="btn btn-lg btn-outline-primary"
                          onClick={() => savePricingFeeSettings('Transaction')}
                        >
                          Save
                        </button>
                      ) : (
                  ...
                  <div className=" text-center h-100">
                    <div className="card-body d-flex flex-column">
                      <div className="mb-4">
                        <h5>Total</h5>
                        <span className="display-4">
                          {isNaN(totalFees) ? 0 : totalFees.toFixed(2)}%
                        </span>
                      </div>
