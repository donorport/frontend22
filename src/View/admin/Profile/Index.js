                  ...
                  <div className="card  card-outline">
                    <div className="card-body box-profile">
                      <div className="text-center p-3">
                        <img
                          ...
                          src={
                            props.tempImg
                              ? props.tempImg
                              : ImageExist(helper.CampaignAdminLogoPath + stateData.Img)
                              ? helper.CampaignAdminLogoPath + stateData.Img
                              : noimg
                          }
                          alt="l"
                        />
                      ...
                      <p className="text-muted text-center">
                        {stateData.role === 2 ? 'CAMPAIGN ADMIN' : 'ADMIN'}
                      </p>
                                      ...
                                      return (
                                        country.status === 1 && (
                                          <option
                                            value={country.id}
                                            selected={
                                              Number(stateData.country) === Number(country.id)
                                            }
                                          >
                                            {country.country}
                                          </option>
                                    ...
                                    props.cityList.map((city) => {
                                      return (
                                        city.status === 1 && (
                                          <option
                                            value={city.id}
                                            selected={stateData.city === city.id}
                                          >
                                            {city.city}
                                          </option>
                                        )
                        ...
                        <div className="tab-pane" id="timeline">
                          <div className="form-group row">
                            ...
                            <div className="col-sm-10">
                              ...
                              />
                              {stateData.error && stateData.error.currentPassword && (
                                <p className="error">
                                  {stateData.error
                                    ? stateData.error.currentPassword
                                      ? stateData.error.currentPassword
                                      : ''
                                    : ''}
                                </p>
                          ...
                          <div className="form-group row">
                            ...
                            <div className="col-sm-10">
                              ...
                              />
                              {stateData.error && stateData.error.newPassword && (
                                <p className="error">
                                  {stateData.error
                          ...
                          <div className="form-group row">
                            ...
                            <div className="col-sm-10">
                              ...
                              />
                              {stateData.error && stateData.error.confirmPassword && (
                                <p className="error">
                                  {stateData.error
                          ...
                          <Button variant="contained" onClick={() => props.updatePassword()}>
                            Update
                          </Button>
                        </div>
