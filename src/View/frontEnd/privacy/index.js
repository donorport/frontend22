          ...
          <div className="terms">
            <div className="mw-900">
              <div className="text-subtext_light fs-5 lh-1.5">
                <strong className="text-dark mb-1">OVERVIEW</strong>
                <br />
                This website is operated by Donorport Ltd. Throughout the site, the terms “we”, “us”
                and “our” refer to Donorport. Donorport offers this website, including all
                ...
                <br />
                <br />
                <strong className="text-dark mb-1">SECTION 1 - ONLINE STORE TERMS</strong>
                <br />
                ...
                <br />
                <br />
                <strong className="text-dark mb-1">SECTION 2 - GENERAL CONDITIONS</strong>
                <br />
                ...
                <br />
                <br />
                <strong className="text-dark mb-1">SECTION 7 - OPTIONAL TOOLS</strong>
                <br />
                ...
                <br />
                <br />
                <strong className="text-dark mb-1">SECTION 8 - THIRD-PARTY LINKS</strong>
                <br />
                ...
                <br />
                <br />
                <strong className="text-dark mb-1">SECTION 10 - PERSONAL INFORMATION</strong>
                <br />
                ...
                <br />
                <br />
                <strong className="text-dark mb-1">SECTION 12 - PROHIBITED USES</strong>
                <br />
                ...
                <br />
                In no case shall bonjohns, our directors, officers, employees, affiliates, agents,
                ...
                <br />
                <br />
                <strong className="text-dark mb-1">SECTION 14 - INDEMNIFICATION</strong>
                <br />
                You agree to indemnify, defend and hold harmless bonjohns and our parent,
                ...
                <br />
                <br />
                <strong className="text-dark mb-1">SECTION 15 - SEVERABILITY</strong>
                <br />
                ...
                <br />
                <br />
                <strong className="text-dark mb-1">SECTION 16 - TERMINATION</strong>
                <br />
                ...
                <br />
                <br />
                <strong className="text-dark mb-1">SECTION 17 - ENTIRE AGREEMENT</strong>
                <br />
                ...
                <br />
                <br />
                <strong className="text-dark mb-1">SECTION 18 - GOVERNING LAW</strong>
                <br />
                ...
                <br />
                <br />
                <strong className="text-dark mb-1">SECTION 19 - CHANGES TO TERMS OF SERVICE</strong>
                <br />
                ...
                <br />
                <br />
                <strong className="text-dark mb-1">SECTION 20 - CONTACT INFORMATION</strong>
                <br />
                Questions about the Terms of Service should be sent to us at support@donorport.com
              </div>
            </div>
          </div>
        </Container>
